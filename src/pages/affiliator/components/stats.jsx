  ...
  return (
    <>
      <div className="flex-1 text-[#585858] pt-5 px-4 @[1000px]:px-8">
        {/* heading section -< represents the logo of AIJO */}
        ...
        <div className="w-full @[650px]:mt-3 @container/stats">
          ...
          <div className="grid w-full @[40em]:grid-cols-2 gap-x-3">
            {/* card one */}
            <div className="border w-full @[600px]:w-auto px-6 py-6 rounded-sm flex flex-col bg-slate-100 shadow-sm mt-3 @[30em]/stats:py-8">
