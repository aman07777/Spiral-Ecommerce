...
const CustomerProfile = () => {
  ...
  const getUserDetails = customerProfileStore(
              ...
              <Flex alignItems="center" bg="gray.50" p={4}>
                ...
                <div className="w-[100%] items-center justify-center mb-4 hidden md:flex">
                  <div className="flex items-center justify-center gap-x-2">
                    <span className="ml-5 text-lg font-bold">My Profile</span>
                    <i>
                      <FaUserCircle className="text-[#008080]" size={20} />
                    </i>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-y-8 w-[100%] ">
                  <div className="grid xl:grid-cols-3 md:grid-cols-2 @[922px]:grid-cols-2 sm:grid-cols-2 gap-y-6  select-none w-[75%] items-center ">
                    <div className="flex flex-col gap-y-2">
                      ...
                      <span className="text-sm tracking-wide font-roboto">{`${userDetails?.firstName} ${userDetails?.lastName}`}</span>
                    </div>
                    <div className="flex flex-col gap-y-2">
                      ...
                      <div>
                        <span className="text-sm tracking-wide font-roboto">
                          {userDetails?.birthDate
                            ? convertBackendDate(userDetails.birthDate)
                            : "Add your birthday"}
                        </span>
                      </div>
                    </div>
                      ...
                      {isLoading ? (
                        ...
                        <>
                          ...
                          <Box ml={4}>
                            ...
                            <Text fontSize="sm">
                              Bonus: <span className="font-roboto">100</span>
                            </Text>
                          </Box>
                        </>
                      )}
